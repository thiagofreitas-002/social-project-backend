...
@push('scripts')
    <script src="https://cdn.tiny.cloud/1/grhe7tayuf3d10o6dynn4gq6jnbbxuy6qnzilcmgs3ebs9ng/tinymce/6/tinymce.min.js"
    ...
    <body class="d-flex justify-content-center flex-column align-items-center">
        ...
        <div class="container d-flex justify-content-center flex-column align-items-center">
            ...
            <div class="content">
                ...
                <form class="mt-5" action="/suporte/update/noticia/{{ $noticia->id }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="image" name="image" placeholder="Imagens"
                            value="{{ $noticia->image }}">
                        @error('description')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
